...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      {/* Alert Banner */}
      <div
        className={`fixed top-0 left-0 right-0 z-50 bg-black/40 backdrop-blur-md text-white py-4 px-6 text-center transition-transform duration-700 delay-2000 border-b border-white/10 ${
      ...
      <section className="flex flex-col items-center justify-center min-h-dvh gap-3 sm:gap-8 md:gap-10 relative z-10 px-3 sm:px-6 py-6 sm:py-0">
        <h1
        ...
        <div
          className={`absolute bottom-3 sm:bottom-8 left-1/2 -translate-x-1/2 transition-all duration-1000 delay-2000 animate-bounce ${
            isLoaded ? "opacity-100" : "opacity-0"
          }`}
        >
          <svg
            className="w-12 h-12 xs:w-16 xs:h-16 sm:w-24 sm:h-24 md:w-28 md:h-28 text-white"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="0.5"
